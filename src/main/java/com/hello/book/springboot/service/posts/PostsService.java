...
import com.hello.book.springboot.web.dto.PostsListResponseDto;
...
public class PostsService {
    ...
    public PostsResponseDto findById (Long id){
        Posts entity = postsRepository.findById(id).orElseThrow(()-> new IllegalArgumentException("해다 게시글이 없습니다. id="+id));
